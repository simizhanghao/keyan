...
1E  LODO                               ← closed this audit
    ...
    → Phase X2 protocol design         ← locked; B0 done, B1 smoke PASS, nominal P1 next; blind six remain sealed

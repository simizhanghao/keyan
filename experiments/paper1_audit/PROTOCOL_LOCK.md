...
1E  LODO                               ← closed this audit
    ...
    → Phase X2 protocol design         ← locked; B0 done, B1 smoke/nominal P1 PASS, C' next; blind six remain sealed

...
function Run-Experiment {
    ...
    $RunDir = "runs\cross_day_oob_main_spf128_eval128\$Name"
    $OutRoot = "outputs\cross_day_oob_main_spf128_eval128\$Name"
...
Run-Step "summarize cross_day_oob_main_spf128_eval128" {
    & $PY scripts\summarize_results.py --root outputs\cross_day_oob_main_spf128_eval128
}

Write-Host ""
Write-Host "Cross-day OOB main SPF128 eval128 runner passed"

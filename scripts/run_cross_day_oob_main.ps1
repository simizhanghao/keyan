...
function Run-Experiment {
    ...
    $RunDir = "runs\cross_day_oob_main\$Name"
    $OutRoot = "outputs\cross_day_oob_main\$Name"
...
Run-Step "summarize cross_day_oob_main" {
    & $PY scripts\summarize_results.py --root outputs\cross_day_oob_main
}

Write-Host ""
Write-Host "Cross-day OOB main runner passed"

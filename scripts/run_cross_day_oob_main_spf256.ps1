...
function Run-Experiment {
    ...
    $RunDir = "runs\cross_day_oob_main_spf256\$Name"
    $OutRoot = "outputs\cross_day_oob_main_spf256\$Name"
...
Run-Step "summarize cross_day_oob_main_spf256" {
    & $PY scripts\summarize_results.py --root outputs\cross_day_oob_main_spf256
}

Write-Host ""
Write-Host "Cross-day OOB main SPF256 runner passed"

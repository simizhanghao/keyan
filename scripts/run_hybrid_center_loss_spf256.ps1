...
function Run-Experiment {
    ...
    $RunDir = "runs\hybrid_center_loss_spf256\$Name"
    $OutRoot = "outputs\hybrid_center_loss_spf256\$Name"
...
Run-Experiment "center_w0001" @("--use-center-loss", "--center-loss-weight", "0.001")
Run-Experiment "center_w0005" @("--use-center-loss", "--center-loss-weight", "0.005")
Run-Experiment "center_w001" @("--use-center-loss", "--center-loss-weight", "0.01")

Run-Step "summarize hybrid_center_loss_spf256" {
    & $PY scripts\summarize_results.py --root outputs\hybrid_center_loss_spf256
}

Write-Host ""
Write-Host "Hybrid center-loss SPF256 runner passed"

...
\begin{tabular}{lcccc}
\hline
Protocol & Purpose & OOB norm & Batch & Label smoothing \\
\hline
Cross-day clean & Main result & z-score & 128 & 0 \\
Deployment LOCO & Extended shift & ratio & 256 & 0.05 \\
Cross-receiver clean & Stress test & ratio & 128 & 0 \\
\hline
\end{tabular}
\end{table}
